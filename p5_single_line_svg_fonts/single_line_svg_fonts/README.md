...
The majority of SVG 1.1 Fonts in this directory, as well as much of the information in this README, are mirrored from [https://gitlab.com/oskay/svg-fonts](https://gitlab.com/oskay/svg-fonts). The majority of these fonts were curated, compiled, and prepared by Dr. Windell Oskay of Evil Mad Scientist Labs / Bantam Tools. 
...
### Additional SVG 1.1 Fonts

Additional SVG 1.1 Fonts in this archive include: 

SVG font name | A derivative of | Designer | Reference/Source
--------------|-----------------|----------|-------------
...
ShriinivasPinyonScript | Pinyon Script | Nicole Fally | [Shriinivas Khemadeva](https://github.com/Shriinivas/etc/tree/master/inkscapestrokefont/fontsvgs)ShriinivasSquarionGrotesk | Squarion Grotesk | Natanael Gama | [Shriinivas Khemadeva](https://github.com/Shriinivas/etc/tree/master/inkscapestrokefont/fontsvgs)
